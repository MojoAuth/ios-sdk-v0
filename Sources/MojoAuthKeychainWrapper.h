//
//  MojoAuthSDKKeychainWrapper.h
//  MojoAuthSDKSDK
//
//  Copyright © 2022 MojoAuthSDK Inc. All rights reserved.
//
//
#import <Foundation/Foundation.h>
#define kPrivateKeyName @"com.mojoauth.private"
#define kPublicKeyName @"com.mojoauth.public"

/**
 The MojoAuthKeychainWrapper class is using SecureEnclave to generate keys and use them to encrypt/decrypt sensitive data.
...
@interface MojoAuthKeychainWrapper : NSObject
...
/**
 *  Initialise a `MojoAuthKeychainWrapper` with a given service and access group.
 *
